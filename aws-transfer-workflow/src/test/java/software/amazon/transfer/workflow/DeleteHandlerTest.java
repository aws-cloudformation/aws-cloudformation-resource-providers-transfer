...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_InvalidRequestExceptionFailed() {
        doThrow(InvalidRequestException.class).when(client).deleteWorkflow(any(DeleteWorkflowRequest.class));
    ...
    public void handleRequest_InternalServiceErrorExceptionFailed() {
        doThrow(InternalServiceErrorException.class).when(client).deleteWorkflow(any(DeleteWorkflowRequest.class));
    ...
    public void handleRequest_ResourceNotFoundExceptionFailed() {
        doThrow(ResourceNotFoundException.class).when(client).deleteWorkflow(any(DeleteWorkflowRequest.class));
    ...
    public void handleRequest_TransferExceptionFailed() {
        doThrow(TransferException.class).when(client).deleteWorkflow(any(DeleteWorkflowRequest.class));
