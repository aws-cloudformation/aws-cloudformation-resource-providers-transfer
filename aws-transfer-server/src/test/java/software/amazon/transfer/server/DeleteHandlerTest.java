...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceModel model = ResourceModel.builder().arn(serverArn.getArn()).build();

        final ResourceHandlerRequest<ResourceModel> request =
                getResourceHandlerRequestBuilder().desiredResourceState(model).build();

        DeleteServerResponse deleteServerResponse = DeleteServerResponse.builder().build();
