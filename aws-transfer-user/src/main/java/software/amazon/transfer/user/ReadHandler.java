...
public class ReadHandler extends BaseHandlerStd {
                ...
                .done(
                        awsResponse ->
                                ProgressEvent.defaultSuccessHandler(
                                        translateFromReadResponse(serverId, awsResponse)));
    }

    private ResourceModel translateFromReadResponse(
            final String serverId, final DescribeUserResponse awsResponse) {
        ...
        return ResourceModel.builder()
                ...
                .homeDirectoryMappings(
                        translateFromSdkHomeDirectoryMappings(user.homeDirectoryMappings()))
    ...
    private List<String> translateFromSshPublicKeys(List<SshPublicKey> sshPublicKeys) {
        ...
        return sshPublicKeys.stream()
                .map(SshPublicKey::sshPublicKeyBody)
