...
public class AbstractTestBase {
    ...
    protected static final Map<String, String> RESOURCE_TAG_MAP =
    ...
    protected static final List<Tag> SYSTEM_TAGS =
            ImmutableList.of(
                    Tag.builder().key("aws:cloudformation:stack-name").value("StackName").build());
                ...
                .homeDirectoryMappings(
                        Arrays.asList(
                                ...
                                HomeDirectoryMapEntry.builder()
                                        ...
                                        .build()))
                .sshPublicKeys(
                        Arrays.asList("ssh-rsa abcdefgh", "ssh-rsa foobar", "ssh-rsa nullkeydate"))
                .tags(MODEL_TAGS)
                .build();
    }
        ...
        return DescribeUserResponse.builder()
                ...
                .user(
                        DescribedUser.builder()
                                ...
                                .posixProfile(
                                        Translator.translateToSdkPosixProfile(
                                                model.getPosixProfile()))
                                .sshPublicKeys(
                                        translateToSdkSshPublicKeys(model.getSshPublicKeys()))
                                .tags(Translator.translateToSdkTags(model.getTags()))
                                .build())
                .build();
    }

    private Collection<software.amazon.awssdk.services.transfer.model.SshPublicKey>
            translateToSdkSshPublicKeys(List<String> sshPublicKeys) {
